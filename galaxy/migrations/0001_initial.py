# Generated by Django 4.2.8 on 2023-12-20 03:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "agent",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="galaxy.agent"
                    ),
                ),
                (
                    "shipyard",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("modules", models.ManyToManyField(to="galaxy.shipmodule")),
                ("mounts", models.ManyToManyField(to="galaxy.shipmount")),
                (
                    "shipyard",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="exchange", to="galaxy.tradegood"
            ),
        ),
        migrations.AddField(
            model_name="market",
            name="exports",
            field=models.ManyToManyField(related_name="exports", to="galaxy.tradegood"),
        ),
        migrations.AddField(
            model_name="market",
            name="imports",
            field=models.ManyToManyField(related_name="imports", to="galaxy.tradegood"),
        ),
        migrations.AddField(
            model_name="market",
            name="waypoint",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("trade_matches", models.ManyToManyField(to="galaxy.markettradegood")),
            ],
            options={
